...
public class ConstantValues {
	//set key & secret in https://apps.twitter.com
    public static String TWITTER_CONSUMER_KEY = "7O1zk8IoyUQfucxiGaCGkUVS6";
    public static String TWITTER_CONSUMER_SECRET = "zEOcr2fDpdDgaUksenOgImM7Il2OWlmW8wTRsAEdBdLoqvKvQR";
